module.exports = message => {
	...
	var fs = require('fs');
	var vore = fs.readdirSync("/home/ikey/Documents/GitHub/KorewaBot/images/Vore/")
	if (!member) {
	  return message.reply(
		...
		file: "/home/ikey/Documents/GitHub/KorewaBot/images/Vore/" + `${vore[(Math.floor(Math.random() * vore.length))]}`});
	}
}